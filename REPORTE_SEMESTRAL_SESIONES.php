...
$xAxisTickValues1 = array(
	new PHPExcel_Chart_DataSeriesValues('String', 'Worksheet!$B$7:$B$12', null, 1),
	);
//SERIE DE DATOS A GRAFICAR
$dataSeriesValues1 = array(
	new PHPExcel_Chart_DataSeriesValues('Number', 'Worksheet!$E$7:$E$12', null, 1),
	);
...
$dataSeriesValues2 = array(
	new PHPExcel_Chart_DataSeriesValues('Number', 'Worksheet!$F$7:$F$12', null, 8),
);
...
$xAxisTickValues3 = array(
	new PHPExcel_Chart_DataSeriesValues('String', 'Worksheet!$B$7:$B$12', null, 5),
);
...
$dataSeriesValues6 = array(
	new PHPExcel_Chart_DataSeriesValues('Number', 'Worksheet!$E$7:$E$12', null, 8),
);
...
$dataSeriesValues8 = array(
    new PHPExcel_Chart_DataSeriesValues('Number', 'Worksheet!$G$7:$G$12', NULL, 12),
		...
		$series7 = new PHPExcel_Chart_DataSeries(
			PHPExcel_Chart_DataSeries::TYPE_LINECHART_3D,     
		    PHPExcel_Chart_DataSeries::GROUPING_STANDARD,   
			range(0, count($dataSeriesValues7)-1),          
			$dataseriesLabels7,                             
			NULL,                                           
			$dataSeriesValues7                              
		);	
		...
		$series8 = new PHPExcel_Chart_DataSeries(
			...
			range(0, count($dataSeriesValues8)-1),          
			$dataseriesLabels8,                             
			NULL,                                           
			$dataSeriesValues8                              
		);
...
header('Content-Disposition: attachment;filename="Reporte Semestral Sesiones.xlsx"');
