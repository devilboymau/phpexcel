...
where  (comites.borrado='0' or comites.borrado is null) and status_sesiones.asistio='1' and num_sesion=".$i." and anio=".$anio.$ccondicion." order by func_direccion.cve_depto_resp,sesiones.fecha_sesion)
	as s1
...
//$vins=0;
$suma=0;
$suma1=0; //SUMA ORDINARIAS
$suma2=0; //SUMA INSTALACION
$suma3=0; //SUMA EXTRAORDINARIAS
$suma4=0; //SUMA INSTALACION
$suma5=0; //SUMA EXTRAORDINARIAS
$sumaT=0; //SUMA TOTAL
$depto="";
...
while($array=pg_fetch_array($query2)){	
		...
		if(trim($array['tipo_sesion'])=='O' && $i=='1'){
...
header('Content-Disposition: attachment;filename="Reporte Asistidas libxml_use_internal_errors().xlsx"');
